  ...
  function recurse (spec) {
    ...
    return Promise
      .map(_this.features, function (filename) {
        ...
        return fs.readFileAsync(pathname, 'utf-8')
          .tap(function () {
          ...
          .catch(function (err) {
            ...
            return "Place holder for "  + filename;
          });
      })
      ...
      .then(function (ast) {
        return spec
          ...
          .then(function (parentSpec) {
            ...
            // If there was no parent spec, return the final AST
            return ast;
          });
      })
      .tap(function (ast) {
...
Spec.prototype.renderBlueprint = function () {
  ...
  return this
    ...
    .then(function(ast){ return helpers.alphabetizeAST(ast, _this);})
